...
| Quadrant 2 x 2 assemblé | quatre cases, frontal complet, huit LED | généré ; la bande de frontal a été reroutée le 18/09/2026 sur la comptabilité de connexité partagée, avec des bus atteignables, un plan de masse et les prises des cellules dessinées ([note 04](04-routeur-et-garanties.md)) ; codes LCSC et devis à faire ([README](../../hardware/quadrant-2x2/README.md)) |
