...
| Quadrant 2 x 2 assemblé | quatre cases, frontal complet, huit LED | généré ; le DRC KiCad du 18/09/2026 compte 117 éléments non connectés (les deux nets du README plus les trous de connexité décrits dans la [note 04](04-routeur-et-garanties.md), à corriger dans `quadgen` comme sur le banc), codes LCSC et devis à faire ([README](../../hardware/quadrant-2x2/README.md)) |
